...
function useAutocomplete({ close }: { close: (autocomplete: Autocomplete) => void }) {
  ...
  const [autocompleteState, setAutocompleteState] = useState<AutocompleteState<any> | EmptyObject>(
    {},
  );
  ...
  const [autocomplete] = useState<Autocomplete>(() =>
    createAutocomplete<any, React.SyntheticEvent, React.MouseEvent, React.KeyboardEvent>({
      id,
